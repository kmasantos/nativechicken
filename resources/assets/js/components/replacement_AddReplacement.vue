                        ...
                        <div class="col s12 m4 l4" v-for="replacement in replacements.data" :key="replacement.id">
                            <div class="card blue-grey lighten-5">
                                ...
                                <div class="card-action right-align">
                                    <a v-bind:href="'add_pheno_morpho?replacement_id='+replacement.family_id" class="tooltipped" data-position="top" data-delay="50" data-tooltip="Pheno/Morpho Details"><i class="fas fa-asterisk"></i></a>
