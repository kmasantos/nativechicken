           ...
           <div class="row">
            ...
            <div class="row">
                ...
                <div class="col s12 l12">
                    ...
                    <p>On the other hand, Itik Pinas is a product of selection and maintained at the National Swine and Poultry Research and Development Center, Tiaong, Quezon.  These Philippine native chickens and ducks have identifiable characteristics that make each genetic group unique.</p>
                ...
                <div class="col s12 l12">
                    <p><strong style="font-weight:bold; font-family: 'Poppins', sans-serif;">Philippine Native Chickens – Rooster.</strong> Unique to Camarines is its yellow-orange plumage with barred pattern.  Darag and Boholano roosters have predominantly red plumage, though if in terms of shank color, Darag roosters have bluish gray while most Boholano roosters have white shanks.  Zampen has red hackle, but the feathers in the body are predominantly black.  All roosters, except Zampen which has pea comb, have single comb type.  In addition, Zampen’s distinguishable feature is its body carriage – it stands upright like a royal!</p>
                ...
                <div class="col s12 l12">
                    ...
                    <p><strong style="font-weight:bold;">Egg production.</strong> Native chickens start to lay eggs at 20 - 22 weeks of age. In terms of egg production of each hen per year, Camarines produce 100 eggs, Zampen produce 105 eggs and Darag produces the highest number of eggs at 11. Boholano breeds, on average, produce 62 eggs per year per hen.</p>
                    ...
                    <p><strong style="font-weight:bold;">Fertility and Hatchability.</strong> In terms of fertility, the Darag and Zampen breed has the highest rate at 81-83% on average. This was followed by the Camarines breed at 69% and the Boholano at 63%. Hatchability of eggs from native chickens range from 70-77%.</p>
            ...
            <div class="row">
                ...
                <div class="col s12 l12">
                    ...
                    <p>The Itik Pinas was developed to breeding true-to-type Philippine mallard ducks selected for high egg production, predictable performance, and consistent product quality. The selection criteria includes Body Weight, Plumage Color and Pattern at 18 weeks of age (BW 18); Egg Number at 40 weeks of age (EN40); and eggs greater than 65 grams prior to incubation.</p>
                    <p>The IP Itim or Itik PINAS Itim and IP Khaki or Itik PINAS Khaki groups were developed due to the high preference of stakeholders on the plumage black and brown color during the stakeholders’ consultation meeting. Based on the result of phenotypic characterization, both male and female of IP Itim lines are black with white ‘bib’ in their neck and IP Khaki have brown plumage color with uniform body weight at 18 weeks of age, producing the egg size suited for processing of balut and with increased egg production. The cross between the two lines produced offspring which you can determine the sex of duckling at day old on their plumage color (sexed linked) with more than 98% accuracy.</p>
                    <p>The project adopted the pyramidal structure of breeding program to distribute the Itik PINAS to the stakeholders. In this structure, there are relatively small number of nucleus breeders at the top which produce purebred stocks of IP Itim and IP Khaki for a larger number of multipliers who in turn produce these animals to a greater number of commercial or small scale duck raisers as end users.</p>
                </div>
                <div class="col s12 l12">
                    <h6 style="font-size:1.3em;">Physical Characteristics</h6>
                </div>
                <div class="col s12 l12">
                    <p>The two Itik Pinas (IP) groups have distinct plumage, neck, bill, shank, and skin color from each other. IP Itim has black plumage color, with white bib, and black bean color. On the other hand, the IP Khaki has brown plumage, plain neck and and black bean color.  IP Khaki drakes have green bills, while ducks have black bills..  Both IP groups have brown eye color, dark orange or dark brown shanks, and are slightly upright.</p>
                ...
                <div class="col s12 l12">
                    <p>Egg production per IP Itim duck per year is 257 eggs, with average egg weight of 65g.  IP Itim starts to lay at about 23 weeks of age.</p>
                    <p>Both IP Itim and IP Khaki have the same egg color (cream) and shape (ovoid). Yolk weight is 21 g.</p>
                </div>
            </div>
            <div class="row">
